...
export default function HomePage() {
  // ✅ এখন HomePage এ কোনো state নেই
  // Carousel এর state HeroCarousel এ isolated
  // ServiceHighlights re-render হবে না
  return (
    <>
      {/* ✅ Carousel আলাদা component এ */}
      <HeroCarousel />
      ...
      {/* ✅ ServiceHighlights এখন re-render হবে না */}
      <ServiceHighlights />
